...
const Patient = () => (
	<svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18">
		<path
			id="ic_face_24px"
			d="M8.3,10.775A1.125,1.125,0,1,0,9.425,11.9,1.125,1.125,0,0,0,8.3,10.775Zm5.4,0A1.125,1.125,0,1,0,14.825,11.9,1.125,1.125,0,0,0,13.7,10.775ZM11,2a9,9,0,1,0,9,9A9,9,0,0,0,11,2Zm0,16.2A7.21,7.21,0,0,1,3.8,11a7.3,7.3,0,0,1,.045-.774A9.056,9.056,0,0,0,8.534,5.393,8.977,8.977,0,0,0,15.878,9.2,8.784,8.784,0,0,0,17.9,8.966,7.189,7.189,0,0,1,11,18.2Z"
			transform="translate(-2 -2)"
			fill="#6dd3f9"
		/>
	</svg>
